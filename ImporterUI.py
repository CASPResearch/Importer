...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.label_10.setGeometry(QtCore.QRect(10, 171, 111, 21))
        ...
        self.destinationLayerField.setEnabled(False)
        self.destinationLayerField.setGeometry(QtCore.QRect(130, 105, 416, 20))
        self.destinationLayerField.setMaxLength(70)
        self.destinationLayerField.setReadOnly(True)
        ...
        self.destinationPreviewField.setEnabled(False)
        self.destinationPreviewField.setGeometry(QtCore.QRect(130, 175, 416, 20))
        self.destinationPreviewField.setMaxLength(70)
        self.destinationPreviewField.setReadOnly(True)
        ...
        self.masterLayerField.setEnabled(False)
        self.masterLayerField.setGeometry(QtCore.QRect(130, 200, 416, 20))
        self.masterLayerField.setMaxLength(70)
        self.masterLayerField.setReadOnly(True)
        self.masterLayerField.setObjectName(_fromUtf8("masterLayerField"))
        self.masterPreviewField = QtGui.QLineEdit(Dialog)
        self.masterPreviewField.setEnabled(False)
        self.masterPreviewField.setGeometry(QtCore.QRect(130, 225, 416, 20))
        self.masterPreviewField.setMaxLength(70)
        self.masterPreviewField.setReadOnly(True)
        self.masterPreviewField.setObjectName(_fromUtf8("masterPreviewField"))
        self.pushButton = QtGui.QPushButton(Dialog)
        self.pushButton.setGeometry(QtCore.QRect(645, 140, 46, 22))
        ...
        self.label_21.setGeometry(QtCore.QRect(45, 221, 76, 21))
        ...
        self.destinationPreviewCount.setGeometry(QtCore.QRect(555, 175, 46, 20))
        ...
        self.label_22.setGeometry(QtCore.QRect(610, 176, 46, 16))
        ...
        self.masterLayerCount.setGeometry(QtCore.QRect(555, 200, 46, 20))
        ...
        self.label_23.setGeometry(QtCore.QRect(610, 201, 46, 16))
        ...
        self.masterPreviewCount.setGeometry(QtCore.QRect(555, 225, 46, 20))
        ...
        self.destinationBackupPathField.setMaxLength(70)
        ...
        self.masterBackupPathField.setMaxLength(70)
        ...
        self.pushButton_11.setGeometry(QtCore.QRect(645, 200, 46, 22))
        self.pushButton_11.setObjectName(_fromUtf8("pushButton_11"))
        self.pushButton_12 = QtGui.QPushButton(Dialog)
        self.pushButton_12.setGeometry(QtCore.QRect(645, 175, 46, 22))
        ...
        self.pushButton_14.setGeometry(QtCore.QRect(645, 225, 46, 22))
        ...
        self.destinationPathField = QtGui.QPlainTextEdit(Dialog)
        self.destinationPathField.setEnabled(False)
        self.destinationPathField.setGeometry(QtCore.QRect(130, 130, 416, 41))
        ...
        Dialog.setTabOrder(self.pushButton_16, self.pushButton_15)
        Dialog.setTabOrder(self.pushButton_15, self.pushButton_13)
        Dialog.setTabOrder(self.pushButton_13, self.pushButton)
        Dialog.setTabOrder(self.pushButton, self.pushButton_12)
        Dialog.setTabOrder(self.pushButton_12, self.pushButton_11)
        Dialog.setTabOrder(self.pushButton_11, self.pushButton_14)
        Dialog.setTabOrder(self.pushButton_14, self.pushButton_9)
        Dialog.setTabOrder(self.pushButton_9, self.pushButton_10)
        Dialog.setTabOrder(self.pushButton_10, self.projectPathField)
        Dialog.setTabOrder(self.projectPathField, self.destinationPreviewField)
        Dialog.setTabOrder(self.destinationPreviewField, self.masterPreviewCount)
        Dialog.setTabOrder(self.masterPreviewCount, self.masterLayerField)
        Dialog.setTabOrder(self.masterLayerField, self.destinationPreviewCount)
        Dialog.setTabOrder(self.destinationPreviewCount, self.destinationLayerCount)
        Dialog.setTabOrder(self.destinationLayerCount, self.masterLayerCount)
        Dialog.setTabOrder(self.masterLayerCount, self.masterPreviewField)
        Dialog.setTabOrder(self.masterPreviewField, self.inputLayerCount)
        Dialog.setTabOrder(self.inputLayerCount, self.radioButtonsedimentary)
        Dialog.setTabOrder(self.radioButtonsedimentary, self.radioButtonigneous)
        Dialog.setTabOrder(self.radioButtonigneous, self.radioButtonSamples)
        Dialog.setTabOrder(self.radioButtonSamples, self.radioButtonSummaryAges)
        Dialog.setTabOrder(self.radioButtonSummaryAges, self.radioButtonSampleAnalyses)
        Dialog.setTabOrder(self.radioButtonSampleAnalyses, self.radioButtonRawExcel)
        Dialog.setTabOrder(self.radioButtonRawExcel, self.destinationBackupPathField)
        Dialog.setTabOrder(self.destinationBackupPathField, self.inputLayerField)
        Dialog.setTabOrder(self.inputLayerField, self.masterBackupPathField)
        Dialog.setTabOrder(self.masterBackupPathField, self.destinationLayerField)
